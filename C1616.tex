...
\subsubsection{Primitives de polynôme exponentiels.}
Un polynôme exponentiel est une fonction de la forme $x\rightarrow P(x)e^{\lambda x}$ \index{polynôme-exponentiel}
\begin{itemize}
...
\begin{defi}[polynôme-exponentiel]
...
Cas où le second membre est un polynôme exponentiel $t\rightarrow P(t)e^{\lambda t}$.\newline
