...
\begin{thm}
  ...
  \end{displaymath}
  Dans ce cas la fonction $\phi$ est définie par
  \begin{displaymath}
...
\end{thm}
\begin{demo}
  À cause de la proposition \ref{modulaire_ordre_n} qui exprime $\varphi(A_1, \cdots, A_p) = \varphi(A_1,\cdots,A_p)$ les deux conditions sont nécessaires.\newline
